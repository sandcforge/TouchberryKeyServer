  ...
  render() {
    ...
    return (
      <div style={footerContainerStyle}>
        <div style={footerTextStyle}>© Copyright 2017 touchberry.net </div>
        <br/>
        <div style={footerTextStyle}>Support: support@touchberry.net </div>
        <a href=''>
        ...
        <IconButton
          tooltip={'Wechat'}
          onTouchTap={ () => this.refs.refWeChatModalDialog._handleOpen() }
          >
        ...
        <IconButton
          tooltip={'Twitter'}
          onTouchTap={ () => this.refs.refPlaceModalDialog._handleOpen() }
          >
